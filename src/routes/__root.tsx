...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Production-grade agentic analytics platform with NL→SQL, in-browser DuckDB, and persistent memory." },
      { name: "author", content: "RosterIQ" },
      { property: "og:title", content: "RosterIQ — AI Analytics Agent" },
      { property: "og:description", content: "Ask data anything. RosterIQ plans, queries, visualizes, and remembers." },
