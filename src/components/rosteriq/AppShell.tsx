...
import { Brain, Database, Sparkles, Network, LayoutDashboard } from "lucide-react";
...
export function AppShell({ children }: { children?: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen text-foreground">
      <aside className="w-60 shrink-0 border-r border-border/60 glass flex flex-col p-4 sticky top-0 h-screen">
